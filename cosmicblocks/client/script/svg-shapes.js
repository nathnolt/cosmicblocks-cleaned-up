...
export const svg_block_circled = `<circle fill="none" class="oShape" stroke="#000000" stroke-width="5" cx="40" cy="40" r="30"/>`

// Unused thing.
export const svg_block_circled_outline = `<path class="outline" d="M40,74.5C20.977,74.5,5.5,59.023,5.5,40S20.977,5.5,40,5.5S74.5,20.977,74.5,40S59.023,74.5,40,74.5L40,74.5 z"/>`
...
export const svg_block_arrow1 = `<polygon class="shape" points="22.42,57.58 46.762,52.419 40,47.071 59.445,27.626 52.374,20.555 32.929,40 27.582,33.238 "/>`
export const svg_block_arrow2 = `<polygon class="shape" points="40,64.861 53.563,44 45,45 45,17.5 35,17.5 35,45 26.438,44 "/>`
export const svg_block_arrow3 = `<polygon class="shape" points="57.58,57.58 52.419,33.238 47.071,40 27.626,20.555 20.555,27.626 40,47.071 33.238,52.419 "/>`
export const svg_block_arrow4 = `<polygon class="shape" points="15.139,40 36,53.563 35,45 62.5,45 62.5,35 35,35 36,26.438 "/>`
export const svg_block_arrow6 = `<polygon class="shape" points="64.861,40 44,26.438 45,35 17.5,35 17.5,45 45,45 44,53.563 "/>`
export const svg_block_arrow7 = `<polygon class="shape" points="22.42,22.42 27.582,46.762 32.929,40 52.374,59.445 59.445,52.374 40,32.929 46.762,27.582 "/>`
export const svg_block_arrow8 = `<polygon class="shape" points="40,15.139 26.438,36 35,35 35,62.5 45,62.5 45,35 53.563,36 "/>`
export const svg_block_arrow9 = `<polygon class="shape" points="57.58,22.42 33.238,27.581 40,32.929 20.555,52.374 27.626,59.445 47.071,40 52.419,46.762 "/>`

export const svg_block_hbar = `<rect class="shape" x="17.5" y="35" width="45" height="10"/>`
export const svg_block_vbar = `<rect class="shape" x="35" y="17.5" width="10" height="45"/>`
export const svg_block_tlbr = `<rect class="shape" x="17.5" y="35" transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 40 96.5684)" width="45" height="10"/>`
export const svg_block_bltr = `<rect class="shape" x="17.5" y="34.999" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -16.5682 40.0007)" width="45" height="10"/>`

export const svg_block_ice = `<rect fill="#B6E3FF" width="80" height="80"/>
...
export const svg_block_knight = `<path 
...
export const svg_block_reclaim = `
